                        ...
                        .notes =
                                {
                                        ...
                                        data::songs::Note{.start_timestamp_ms = 2502,
                                                          ...
                                                          .fret = 0,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 2919,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 3336,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 3753,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 4170,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 4587,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 0,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 5004,
                                                          .length_ms = 625,
                                                          .midi_note = 0,
                                                          .fret = 0,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 5629,
                                                          .length_ms = 208,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 5837,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 6254,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 0,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 6671,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 0,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 7088,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 7505,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 7922,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 8339,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 8756,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 0,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 9173,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 9590,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 10007,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 10424,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 10841,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 0,
                                                          .string = static_cast<uint8_t>(string_e::HIGH_E)},
                                        data::songs::Note{.start_timestamp_ms = 11258,
                                                          .length_ms = 682,
                                                          .midi_note = 0,
                                                          .fret = 3,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 11940,
                                                          .length_ms = 208,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::B)},
                                        data::songs::Note{.start_timestamp_ms = 12148,
                                                          .length_ms = 417,
                                                          .midi_note = 0,
                                                          .fret = 1,
                                                          .string = static_cast<uint8_t>(string_e::B)},
